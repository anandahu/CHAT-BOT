...
@api.route('/student_view_attentence',methods=['post'])
def student_view_attentence():
	data={}
	lid=request.form['lid']
	hj="SELECT * FROM `attendnace` where student_id=(select student_id from student where login_id='%s')"%(lid)
	res=select(hj)
	if res:
